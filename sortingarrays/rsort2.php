...
rsort($numbers); //mengurutkan number dari beberapa nilai variabel yang ada dalam array dengan menurun urutan numerik
...
for($x = 0; $x < $arrlength; $x++) {//menambah banyak sesuai nilai yang telah dimasukkan
    echo $numbers[$x];//menampilkan hasil urutan numbers dengan menurun urutan numerik
    echo "<br>";
}
?>
